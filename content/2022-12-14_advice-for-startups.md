...
description: Bootstrapped first-time startups often fail because they don't have the time and money to make mistakes. This is my decade of experience distilled to an 80/20 path to success.
image:
  src: https://img.ghunt.io/online-business-startup.jpeg?fm=webp&w=1200&h=800
  alt: Online Business Startup
---
...
For this reason, there needs to be a resolve when starting to not go after perfection. Rather, go after the large easy wins. Do the things that will give you results fastest and _iterate_ over them.
...
- **Performance/Pagespeed**: is an important metric of how fast your webpage _appears_ to load. For every second your page takes to load, expect to lose exponentially more customers.
...
- **[Google Fonts](https://fonts.google.com/)**: great place to explore high quality open source fonts to use in your brand. Use the text preview to experiment with your logo text. All fonts are free to use in your media.

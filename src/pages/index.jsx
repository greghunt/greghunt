...
function Newsletter() {
  return (
    <form
      action="https://app.convertkit.com/forms/3859070/subscriptions"
      method="post"
...
function Resume() {
  let resume = [
    {
      company: 'Fresh Brewed Web Inc.',
      title: 'Owner',
      logo: 'https://img.ghunt.io/fresh-brewed-web-icon.png',
      start: '2015',
      end: {
        label: 'Present',
    ...
    },
    {
      company: 'Motto',
      title: 'CTO',
      logo: 'https://img.ghunt.io/motto-icon.png',
      start: '2017',
      end: '2022',
    },
    {
      company: 'JTD Solutions',
      title: 'Web Developer',
      logo: 'https://img.ghunt.io/jtd-solutions.png',
      start: '2011',
      end: '2015',
    },
    {
        ...
        {resume.map((role, roleIndex) => (
          <li key={roleIndex} className="flex gap-4">
            <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
              <img src={role.logo} alt="" className="h-7 w-7 object-cover" />
            </div>

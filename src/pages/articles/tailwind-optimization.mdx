...
export const meta = {
  ...
  categories: ['frontend'],
  description:
    'Tailwind CSS has helped us enourmously in optimizing our styles. However, there are still ways to write it inefficiently that we should be thinking about.',
}
